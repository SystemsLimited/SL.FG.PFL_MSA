...
namespace SL.FG.PFL.WebParts.MSAForm
{
    ...
    public partial class MSAFormUserControl : UserControl
    {
        ...
        private bool IsMSASubmitted(SPWeb oSPWeb, int scheduleId)
        {
            ...
            {
                SPDiagnosticsService.Local.WriteTrace(0, new SPDiagnosticsCategory("SL.FG.PFL(MSAForm->IsMSASubmitted)", TraceSeverity.Unexpected, EventSeverity.Error), TraceSeverity.Unexpected, ex.Message, ex.StackTrace);
